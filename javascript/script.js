...
var dayNames = ["Sunday","Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" ]; //day names array
...
function getGender(){
  ...
  switch(gender){
    ...
    break //break if solution is found
    default:
          
  }
}
function findName(){
  dayValue = calculateDayValue(); // assigning day value to calculate day value variable function
  getGender();
}
// end
